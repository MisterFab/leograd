...
a_custom = Tensor(a_vals, dtype=np.float32)
b_custom = Tensor(b_vals, dtype=np.float32)
...
a_torch = torch.tensor(a_vals, requires_grad=True, dtype=torch.float32)
b_torch = torch.tensor(b_vals, requires_grad=True, dtype=torch.float32)
